...
# https://wiki.seeedstudio.com/Grove-3-Axis-Digital-Accelerometer-_LIS3DHTR/#play-with-raspberry-pi
...
def demo():
    while True:
        ...
        sensor = Grove3AxisDigitalAccelerometer()
        accl = sensor.read()

        print(" Acceleration in X-Axis : {}".format(str(accl['x'])))
        print(" Acceleration in Y-Axis : {}".format(str(accl['x'])))
        print(" Acceleration in Z-Axis : {}".format(str(accl['x'])))
        print(" ************************************ ")
